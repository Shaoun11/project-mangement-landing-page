    ...
    return (
        ...
        <div>
            ...
            <div className='grid lg:grid-cols-3 mt-16 grid-cols-1 lg:ml-0 md:ml-28  md:pl-16 md:pr-16 ml-2 gap-6'>
                {/* Testimonials Card:1 */}
                <div>
                    <blockquote className="rounded-lg bg-[#FFF] border-[#91929533] border-[1px] solid p-8 w-[416px] h-[350px] shadow-sm sm:p-8">
                        ...
                        <p className="mt-4 text-[#101219] font-normal text-[20px]">
